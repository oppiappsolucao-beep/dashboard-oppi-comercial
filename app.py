...
def apply_dashboard_css() -> None:
    render_html(
        ...
        <style>
            ...
            /* Correção final: mantém o design original do menu lateral.
               O Cadastro continua funcional como popover lateral, mas visualmente
               fica igual aos demais itens do menu, sem caixa branca ou seta para baixo. */
            section[data-testid="stSidebar"] .st-key-sidebar_menu_visao_geral,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_visao_geral_active,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_cadastro,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_cadastro_active,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_pesos_medidas,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_pesos_medidas_active {
                width: 100% !important;
                margin: 0 !important;
                padding: 0 !important;
                overflow: visible !important;
            ...
            section[data-testid="stSidebar"] .st-key-sidebar_menu_visao_geral button,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_visao_geral_active button,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_cadastro div[data-testid="stPopover"] > button,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_cadastro_active div[data-testid="stPopover"] > button,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_pesos_medidas button,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_pesos_medidas_active button {
                width: 100% !important;
                min-height: 38px !important;
            ...
            section[data-testid="stSidebar"] .st-key-sidebar_menu_visao_geral button > div,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_visao_geral_active button > div,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_cadastro div[data-testid="stPopover"] > button > div,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_cadastro_active div[data-testid="stPopover"] > button > div,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_pesos_medidas button > div,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_pesos_medidas_active button > div {
                width: 100% !important;
                display: flex !important;
                align-items: center !important;
                justify-content: flex-start !important;
            ...
            section[data-testid="stSidebar"] .st-key-sidebar_menu_visao_geral button p,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_visao_geral_active button p,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_cadastro div[data-testid="stPopover"] > button p,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_cadastro_active div[data-testid="stPopover"] > button p,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_pesos_medidas button p,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_pesos_medidas_active button p,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_visao_geral button span,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_visao_geral_active button span,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_cadastro div[data-testid="stPopover"] > button span,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_cadastro_active div[data-testid="stPopover"] > button span,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_pesos_medidas button span,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_pesos_medidas_active button span {
                margin: 0 !important;
                padding: 0 !important;
                color: #241C34 !important;
                font-size: 0.93rem !important;
            ...
            section[data-testid="stSidebar"] .st-key-sidebar_menu_visao_geral button::before,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_visao_geral_active button::before,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_cadastro div[data-testid="stPopover"] > button::before,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_cadastro_active div[data-testid="stPopover"] > button::before,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_pesos_medidas button::before,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_pesos_medidas_active button::before {
                content: "" !important;
                ...
                border: 1px solid rgba(70,62,90,0.34) !important;
            ...
            section[data-testid="stSidebar"] .st-key-sidebar_menu_cadastro_active div[data-testid="stPopover"] > button::before,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_pesos_medidas_active button::before {
                border: 4px solid #FF5C64 !important;
                background: #FFFFFF !important;
                box-shadow: none !important;
            }

            section[data-testid="stSidebar"] .st-key-sidebar_menu_cadastro div[data-testid="stPopover"] > button svg,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_cadastro_active div[data-testid="stPopover"] > button svg {
                display: none !important;
            }
            ...
            section[data-testid="stSidebar"] .st-key-sidebar_menu_visao_geral button:hover,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_visao_geral_active button:hover,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_cadastro div[data-testid="stPopover"] > button:hover,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_cadastro_active div[data-testid="stPopover"] > button:hover,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_pesos_medidas button:hover,
            section[data-testid="stSidebar"] .st-key-sidebar_menu_pesos_medidas_active button:hover {
                transform: translateX(3px) !important;
                color: #7D2DFF !important;
                background: transparent !important;
                box-shadow: none !important;
